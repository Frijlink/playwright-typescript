...
export default class HomePage {
    ...
    constructor(page: Page) {
        ...
        this.newBoardBtn = this.page.locator('[data-test-id="create-board-tile"]')
        this.newBoardNameInput = this.page.locator('[data-test-id="create-board-title-input"]')
        ...
        this.createNewBoardSubmitBtn = this.page.locator('[data-test-id="create-board-submit-button"]')
